                    ...
                    <div style="display: flex;justify-content: flex-end;">
                        <form class="form-inline">
                            ...
                            <div class="form-group mx-sm-3 mb-2">
                                ...
                                <input type="text" class="form-control" placeholder="Search By Batch Name" name="search" id="search" style="border-radius:20px;color:black;" >
                            </div>
...
<!--                                <th><strong>Batch Time</strong></th>-->
                            ...
                            <?php
                            if($search == "") {
                                $sql = "SELECT * FROM batch_profile ORDER BY id  LIMIT $start,10";
                            }
                            else {
                                $sql = "SELECT * FROM batch_profile WHERE batch_name = '$search' ORDER BY id  LIMIT $start,10";
                            }
                        ...
                        //   $career_dates =   $row['career_date'];
                           //$start =   $row['start_time'];
                            $start= date(strtotime('h:i:sA' ,$row['start_time']));

                            ?>
                            <tbody>
                            <tr>
                                <td><strong><?php echo $sNo;?></strong></td>
                                <td><?php echo strtoupper($row['batch_id'])?></td>

                                   <td> <?php echo strtoupper($row['batch_name'])?> </td>
                        ...
                        <div class="col-12 pl-3" style="display: flex;justify-content: center;">
                            <nav>
                                <ul class="pagination pagination-gutter pagination-primary pagination-sm no-bg">
                                    ...
                                    $sql = 'SELECT COUNT(id) as count FROM  batch_profile;';
                                    $result = mysqli_query($conn, $sql);
                            ...
                            <form id="doner_form" autocomplete="off">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="Batch Name" id="batch_name" name="batch_name" style="border-color: #181f5a;color: black">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="time" class="form-control"  id="start_time" name="start_time" style="border-color: #181f5a;color: black">
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label>End time *</label>
                                        <input type="time" class="form-control"  id="end_time" name="end_time" style="border-color: #181f5a;color: black">
                                    </div>
                                    <!-- <div class="form-group col-md-12">
                                        <label>Pan NO *</label>
   ...
   function editTitle(data) {
       ...
       $.ajax({
           ...
           success: function(res){
               ...
               {
                   $("#batch_id").val(res.doner_id);
                   $("#batch_name").val(res.doner_name);
                   $("#time").val(res.mobile);
                //    $("#pan").val(res.pan);
                //    $("#email").val(res.email);
                ...
                //     }
                   ...
                   var edit_model_title = "Edit Batch - "+data;
   ...
   $("#doner_form").validate(
       {
           ...
           messages: {
            ...
            batch_time: "*This field is required",
