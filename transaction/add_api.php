  ...
  //  $added_by = $_COOKIE['staff_id'];
   ...
   // $sqlValidateCookie = "SELECT * FROM `admin_login` WHERE panel_api_key='$api_key'";
    ...
    if (mysqli_num_rows($resValidateCookie) > 0) {
        ...
        $sqlInsert = "INSERT INTO `transaction`(`pay_id`,`doner_name`,`dob`,`address`,`mobile`,`pan`,`amount`,`pay_mode`,`added_by`,`branch_name`,`date`,`doner_id`,`batch_id`,`mobile1`,`remark`,`transaction_id`,`type`) 
                                            VALUES ('','$doner_name','$dob','$address','$mobile','$pan','$amount','$pay_mode','$added_by','$branch_name','$date','$doneriD','$batch_idT','$mobile1','$remark','$transaction_id','$type')";
