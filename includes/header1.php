                    ...
                    <li class="nav-item dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                            ...
                            <div class="header-info">
                                <span class="text-black" style ="text-transform:capitalize;"><?php echo "Super Admin"; ?></span>
                                <span class="text-black" style ="text-transform:capitalize;"><?php echo "Logistic"; ?></span>
                                <span class="text-black" style ="text-transform:capitalize;"><?php echo ""; ?></span>
                                <p class="fs-12 mb-0">
                                    <?php
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item ai-icon">
                                ...
                                <span class="ml-2"><?php  echo "Super Admin";?></span>
                            </a>
