...
$donation_dates = date("d-m-Y", strtotime($donation_date));
$pan = $_GET['pan'];
...
<div id="printPdf" style="border: 7px solid #3c99e6; height:80%; margin-right:8px;">
    <div class="headerPdf flex-container">
        <div class="pdfLogo flex-start" style="margin-left: 25px;margin-top: 10px;">
            <img src="../images/god/final_logo.png" style="height: 190px;width: 190px;">
        </div>
        <div class="headerCont flex-end" style="margin-left: 25px;font-family: 'Poppins', sans-serif;">
            ...
            <h5 style="line-height: 1.6;text-align: center;"><strong>J.J ACT REGD NO: MW5MWQFK1681902790</strong></h5>
            ...
            <h5 style="line-height: 1.6;text-align: center;"><strong>Mobile: 8939332777 | Website: www.atct.in </strong></h5>
        ...
        <div class="mainContent_pdf s row" style="margin-top: 15px;">
            ...
            <div class="left column">
                ...
                <div style="margin-top: 9px;margin-left: 25px;">
                    <p style="display: inline-block;font-family: 'Poppins', sans-serif;">Donation Date :</p><span style="border-bottom: 1px dashed black;font-family: 'Poppins', sans-serif;"> <?php echo $donation_date?></span>
                </div>
            ...
            <div style="width: 570px; margin-top: 0px;" class="end">
                <p style="word-wrap: break-word;margin-top: 0px; text-align: center ;font-family: 'Poppins', sans-serif; font-weight: 400">Thank you very much to support<strong> ANNAI TERESA OLD AGE HOME  AND CHILDREN HOME </strong> to give a better life to the orphan children who are greatly in need.</p>
            ...
            <div class="left column">
             <p style="margin-top: 0px!important; font-family: 'Great Vibes', cursive; font-size: 25px;">Helping orphaned children is a reflection of these values and a commitment to ensuring that all children have a chance at a better life.
            ...
            <div class="right column">
                ...
                <div style="display: flex;justify-content: end; margin-bottom:-5px;margin-top: 25px; margin-right: -20px; height:100px !important;">
...
<!--    <hr style="margin-top: 10px;">-->
    ...
    <div class="headerContS flex-center" style="font-family: 'Poppins', sans-serif;">
        ...
        <h5 style="text-align: center; margin-bottom: 30px!important;"><strong>Hospitalization Support : Open Heart Surgery | Cancer Treatment</strong></h5>
    </div>
